...
export default function CallToAction({darkMode}) {
  return (
    <section className="w-full py-12 px-4 bg-gradient-to-br from-[#072126] via-[#102E50] to-[#1F4562] text-white text-center">
      <h2 className={`text-2xl md:text-3xl font-bold mb-4 ${darkMode?"text-black":"text-gray-300"}`}>
        Let’s Work Together
      </h2>
      <p className={`max-w-xl mx-auto text-sm md:text-base mb-6 ${darkMode?"text-black":"text-gray-300"}`}>
      ...
      <p className={`text-base mb-4 ${darkMode?"text-black ":"text-gray-300"}`}>
