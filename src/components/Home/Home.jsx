...
export default function Home() {
  return (
    <section className="mt-16 w-full min-h-[90vh] flex flex-col items-center justify-center text-center bg-gradient-to-br from-gray-50 to-blue-100 px-4 relative overflow-hidden">
      ...
      <p className="m-2">Social Media Links</p>
