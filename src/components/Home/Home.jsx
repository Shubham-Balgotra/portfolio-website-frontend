...
>
  ...
  <div
    ...
    style={{
      transform: window.innerWidth >= 1920 ? "scale(1.05)" : "scale(1)",
    }}
  >
    <div className="flex flex-col items-center text-center md:items-start md:text-left max-w-xl z-10">
  ...
  {/* RIGHT: IMAGE */}
  <div
    className="flex-1 flex justify-center transition-transform duration-500"
    style={{
      transform: window.innerWidth >= 1920 ? "scale(1.05)" : "scale(1)",
    }}
  >
