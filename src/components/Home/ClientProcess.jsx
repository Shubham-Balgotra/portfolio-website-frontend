...
export default function ClientProcess({ darkMode }) {
  return (
    ...
    >
      <div
        className={`
          max-w-[1600px] w-full flex flex-col items-center justify-center
          scale-[0.94] sm:scale-[0.98] md:scale-100 xl:scale-[1.04] 2xl:scale-[1.08] custom-3xl:scale-[1.12]
          transition-transform duration-500 ease-in-out
        `}
      >
        {/* Title */}
